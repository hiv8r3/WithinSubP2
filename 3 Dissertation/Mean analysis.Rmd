...
```{r}
m1 = lmer(meanAmp ~ TarRace.e*TarGender.e + (TarRace.e*TarGender.e|Subject), data = gendat)
...
```{r}
m2 = lmer(meanAmp ~ TarRace.e*TarGender.e + (TarRace.e+TarGender.e|Subject), data = racedat)
