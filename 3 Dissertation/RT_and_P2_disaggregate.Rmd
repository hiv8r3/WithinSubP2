...
``` {r}
dat$Condition = paste(dat$TarGender, dat$TarRace, sep="_")
...
### A. Race categorization task
```{r}
b5 = lmer(RT ~ P2.submean+P2.withinSub.withinStim+P2.withinSub.betweenStim + (1|Subject), data = filter(dat, Task == "RaceTask"))
summary(b5)

b6 = lmer(RT ~ P2.submean+P2.withinSub.withinStim.scale+P2.withinSub.betweenStim + (1|Subject), data = filter(dat, Task == "RaceTask"))
summary(b6)
...
### B. Gender categorization task
```{r}
b7 = lmer(RT ~ P2.submean+P2.withinSub.withinStim+P2.withinSub.betweenStim + (1|Subject), data = filter(dat, Task == "GenTask"))
summary(b7)

b8 = lmer(RT ~ P2.submean+P2.withinSub.withinStim.scale+P2.withinSub.betweenStim + (1|Subject), data = filter(dat, Task == "GenTask"))
summary(b8)
